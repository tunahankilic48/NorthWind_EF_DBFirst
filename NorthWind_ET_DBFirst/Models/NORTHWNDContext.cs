...
namespace NorthWind_EF_DBFirst.Models
{
    public partial class NORTHWNDContext : DbContext
    {
        ...
        public virtual DbSet<VwCondimentsKategorisiEnPahali10Urun> VwCondimentsKategorisiEnPahali10Uruns { get; set; } = null!;
        public virtual DbSet<VwKritikSeviyeUrunBilgileri> VwKritikSeviyeUrunBilgileris { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-A10URF2\\SQLEXPRESS;Database=NORTHWND;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VwCondimentsKategorisiEnPahali10Urun>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_CondimentsKategorisiEnPahali10Urun");
            ...
            modelBuilder.Entity<VwKritikSeviyeUrunBilgileri>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_KritikSeviyeUrunBilgileri");

                entity.Property(e => e.CategoryName).HasMaxLength(15);

                entity.Property(e => e.CompanyName).HasMaxLength(40);

                entity.Property(e => e.MinimumSiparişMiktarı).HasColumnName("Minimum Sipariş Miktarı");
